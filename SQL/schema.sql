...
-- (Dữ liệu giao dịch mẫu: process_request / request_item / stock_inquiry / purchase_order /
--  po_detail / audit_log đã được bỏ — DB khởi tạo sạch, chỉ còn master data + accounts.)
